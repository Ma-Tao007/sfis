	...
	<head>
		...
		<script type="text/javascript">
			...
			function activate()
			{
				...
				$.get("parentActivate?tchNO="+id,null,activateBack);				
			}
	...
	<div id="center">
		<table>
				<tr>
					...
					<td width="200px"><a href="../teacher/activate.jsp">教师激活页面</a></td>
					<td width="200px"><h1>家长注册页面</h1></td>
				</tr>
			</table>
		
				<form action="parentActivate.jsp" method="post" onsubmit="return validate();">
					<div class="textInput">
						学生学号<input type="text" name="tchNO" id="tchNO" onfocus="inputTtchNO();" onblur="activate();"/><label style="color: red" id="inputtchNO"></label>
					</div>
					
					<div class="textInput">
						&nbsp;&nbsp;手机号<input type="text" name="email" id="email" onfocus="inputemail();" onblur="inputmail();"/><label id="inputmail"></label>
					</div>
					
					<div class="textInput">
						&nbsp;&nbsp;&nbsp;&nbsp;姓名<input type="text" name="name" id="name" onfocus="inputPName();" onblur="inputName();"/><label  style="color: red" id="inputname"></label>
					</div>
