function validate()
{
	...
	if(email.length!=11 )
	{
		document.getElementById("inputmail").innerHTML="手机号位数为11位";
		return false;
	}
	if(name.length==0 )
	{
		document.getElementById("inputname").innerHTML="请填写姓名";
		return false;
	}
...
{
	document.getElementById("inputtchNO").innerHTML="请输入学生学号，用于验证学生是否存在";
...
function inputPName()
{
	document.getElementById("inputname").innerHTML="请输入学生家长姓名";
...
function inputemail()
{
		document.getElementById("inputmail").innerHTML="请输入手机号,是您的登录账号";
