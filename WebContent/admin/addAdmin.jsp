...
<script type="text/javascript">
			...
			function addRow()
			{
				...
				cell3.setAttribute("name", "author");
			...
			function submitData()
			{
				...
				{
					data = data + "&id="+ids[i].value+"&title="+titles[i].value+"&author="+authors[i].value;
				}
...
<div id="contentWrap">
  ...
  <div id="widget table-widget">
    <div class="pageTitle">后台——添加管理员</div>
    <div class="pageColumn">
      ...
      <table id="myTable">
        ...
        <tr>
          ...
          <th width="150px">管理员姓名</th>
          <th width="150px">管理员邮箱</th>
