...
<div id="contentWrap">
  ...
  <div id="widget table-widget">
    <div class="pageTitle">后台——留言列表</div>
    <div class="pageColumn">
      <div class="pageButton"></div>
      <%
        MessageBean messageBean=new MessageBean();
		List<Message> messageList=messageBean.messageAllList();
      ...
      <table>
        ...
        <c:forEach var="message" items="${messageList }" varStatus="status">
          <tr>
            <td class="checkBox"><input name="id"  id="id" type="checkbox" value="${message.id}" /></td>
            <td>${message.id}</td>
            <td>${message.title}</td>
