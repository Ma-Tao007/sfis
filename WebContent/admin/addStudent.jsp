...
<script type="text/javascript">
			...
			function addRow()
			{
				...
				cell2.setAttribute("name", "stuNO");
				var cell3 = document.createElement("input");
				cell3.setAttribute("name", "stuName");
			...
			function submitData()
			{
				...
				var titles = document.getElementsByName("stuNO");
				var authors = document.getElementsByName("stuName");
				
				var url = "addStudent";
				var data = "";
				for(var i = 0; i < ids.length; i++)
				{
					data = data + "&id="+ids[i].value+"&stuNO="+titles[i].value+"&stuName="+authors[i].value;
				}
...
<div id="contentWrap">
  ...
  <div id="widget table-widget">
    <div class="pageTitle">后台——录入学生信息</div>
