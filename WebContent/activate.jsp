...
<html>
	...
	<div id="center">
			...
			<div id="teacher">
				<form action="teacher/teacherActivate.jsp" method="post" onsubmit="return validate();">
					<div class="textInput">
						&nbsp;&nbsp;教师号<input type="text" name="tchNO" id="tchNO" onfocus="inputTtchNO();" onblur="activate();"/><label style="color: red" id="input"></label>
					</div>
