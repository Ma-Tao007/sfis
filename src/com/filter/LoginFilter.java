...
import com.jwillim.util.Constants;
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		// place your code here
				...
				if (!"/".equals(uri) && !"/index.jsp".equals(uri) && !"/login.html".equals(uri)
						&& !"/activate.jsp".equals(uri) && !"/login".equals(uri)  && !"/adminLogin".equals(uri) && !"/activate".equals(uri) && !"/findPassword".equals(uri) && !"/findPassword.jsp".equals(uri)
						&& !uri.contains("/js") && !uri.contains("/css") && !uri.contains("/images") && !uri.contains("/img")  && !uri.contains("/teacherActivate.jsp") && !uri.contains("/register.js") && !uri.contains("/register.css")
						&&!uri.contains("/activate.jsp") && !uri.contains("/login") && !uri.contains("/adminLogin") && !uri.contains("/activate") && !uri.contains("/parentActivate") && !uri.contains("/studentActivate") && !uri.contains("/teacherActivate.jsp")) 
				{
					...
					if (session.getAttribute("student") == null && session.getAttribute("teacher") == null && session.getAttribute("parent") == null && session.getAttribute("admin")==null)
					{
