...
@WebFilter("/parent/*")
public class ParentLoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		// place your code here
				...
				if (!"/".equals(uri) && !"/index.jsp".equals(uri) && !"/login.html".equals(uri)
						...
						&&!uri.contains("/activate.jsp") && !uri.contains("/login") && !uri.contains("/adminLogin") && !uri.contains("/activate") && !uri.contains("/parentActivate") && !uri.contains("/studentActivate")) 
				{
